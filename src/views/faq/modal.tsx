...
//-----------
import * as IFAQ from "@src/domain/models/IFAQ"
import { IContext, FAQContext } from "./useContext"
...
const ModalComponent = () => {
  ...
  const {
    ...
    setValueTag,
    valueTag
  } = useContext<IContext>(FAQContext)
  const optionStatus = [
    {
      value: 1,
      label: t("Active")
  ...
  const { addFaqApi, editFaqApi, getFaqByIdApi, checkInit, getCategoryList } =
    useFaq()
  ...
  const defaultValues: IFAQ.IModel = {
    id: "",
    code: "",
    name: "",
    title: "",
