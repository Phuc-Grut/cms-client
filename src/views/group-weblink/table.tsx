...
import {canContextMenuItems} from "@src/views/group-weblink/contextMenu"
  ...
  return (
    <div className="d-flex justify-content-between align-items-center w-100">
      <div className="bar__action-left">
        <BreadCrumbsNotLink breadCrumbActive={t("Group WebLink")} />
      </div>
      <div className="bar__action-right d-flex">
        <CanPer I={userAction.ADD} a={userSubject.GroupWebLink}>
...
const Table = () => {
  ...
  } = useContext(GroupWebLinkContext)
  // ** States
  ...
  return (
    <Fragment>
      <div className="table-toolbar">
        ...
        <GridTableTemplate
          resource="tableGroupWebLinks"
          idTable="GroupWebLinks"
          // rowHeight={40}
          dataTable={data}
