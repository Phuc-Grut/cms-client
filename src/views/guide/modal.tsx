...
//-----------
import * as IGuide from "@src/domain/models/IGuide"
import { IContext, GuideContext } from "./useContext"
...
const ModalComponent = () => {
  ...
  const {
    ...
    setValueTag,
    valueTag
  } = useContext<IContext>(GuideContext)
  const optionStatus = [
    {
      value: 1,
      label: t("Active")
  ...
  const defaultValues: IGuide.IModel = {
    id: "",
    code: "",
    name: "",
    title: "",
