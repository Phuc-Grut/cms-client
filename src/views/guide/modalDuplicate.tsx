...
import { IDuplicateQuery } from "@src/domain/models/IGuide"
import {
  notificationError,
  notificationSuccess
...
const ModalDuplicate = () => {
  ...
  const { duplicateGuideApi, getGuideByIdApi, checkInit } = useGuide()
  const {
    openModalDuplicate,
