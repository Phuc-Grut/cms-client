...
const BankPage = () => {
  ...
  return (
    <Fragment>
      ...
      {ability.can(userAction.ADD, userSubject.SystemGroupUser) && <GroupUserContext.Provider value={{ openModal, handleModal, dataItem, setDataItem, typeModal, setTypeModal, openModalAddMember, handleModalAddMember, windowSize}} >
      ...
      {ability.cannot(userAction.ADD, userSubject.SystemGroupUser) && (
        <NotPermission/>
      )}
