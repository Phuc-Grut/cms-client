...
import {IFDataProductUser, IFPagingProductUserApi} from "@src/views/system/domain/models/IUsers"
...
export const getPagingProductUserApi = createAsyncThunk<any, IFPagingProductUserApi>(USER.ACTION_TYPES.GET_PAGING_BY_PRODUCT_ID, async (params, thunkAPI) => {
  try {
...
export const getPagingUserApi = createAsyncThunk<any, IFPagingProductUserApi>(USER.ACTION_TYPES.GET_USERS_BY_PRODUCT_ID, async (params, thunkAPI) => {
  try {
...
export const addProductUserApi = createAsyncThunk<any, IFDataProductUser>(USER.ACTION_TYPES.ADD_BY_PRODUCT_ID, async (params, thunkAPI) => {
  try {
...
export const editProductUserApi = createAsyncThunk<any, IFDataProductUser>(USER.ACTION_TYPES.UPDATE, async (params, thunkAPI) => {
  try {
...
export const deleteProductUserApi = createAsyncThunk<any, string>(USER.ACTION_TYPES.DELETE, async (id, thunkAPI) => {
  try {
