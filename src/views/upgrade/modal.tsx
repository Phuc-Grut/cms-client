...
//-----------
import * as IUpgrade from "@src/domain/models/IUpgrade"
import { IContext, UpgradeContext } from "./useContext"
...
const ModalComponent = () => {
  ...
  const {
    ...
    setValueTag,
    valueTag
  } = useContext<IContext>(UpgradeContext)
  const optionStatus = [
    {
      value: 1,
      label: t("Active")
  ...
  const defaultValues: IUpgrade.IModel = {
    id: "",
    code: "",
    name: "",
    title: "",
