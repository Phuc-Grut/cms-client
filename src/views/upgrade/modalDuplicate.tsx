...
import { IDuplicateQuery } from "@src/domain/models/IUpgrade"
import {
  notificationError,
  notificationSuccess
...
const ModalDuplicate = () => {
  ...
  const { duplicateUpgradeApi, getUpgradeByIdApi, checkInit } = useUpgrade()
  const {
    openModalDuplicate,
