...
export const getPagingApi = createAsyncThunk<any, IFPagingGroupCategoryApi>(GROUPCATEGORY.ACTION_TYPES.GET_DATA, async (params, thunkAPI) => {
  try {
...
export const update_sort = createAsyncThunk<any, GroupCategorySort>(GROUPCATEGORY.ACTION_TYPES.GROUPCATEGORY_SORT, async (params, thunkAPI) => {
  try {
