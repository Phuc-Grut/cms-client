...
//-----------
import * as INews from "@src/domain/models/INews"
import { IContext, NewsContext } from "./useContext"
...
const ModalComponent = () => {
  ...
  const {
    ...
    setValueTag,
    valueTag
  } = useContext<IContext>(NewsContext)
  const optionStatus = [
    {
      value: 1,
      label: t("Active")
  ...
  const defaultValues: INews.IModel = {
    id: "",
    code: "",
    name: "",
    title: "",
