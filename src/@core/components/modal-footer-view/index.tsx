      ...
      <Fragment>
        <div className='align-items-center w-100'>
          <div className='d-flex align-items-center'>
            <p className='m-0'>
              <strong style={{color: '#5e5873'}}>Ngày tạo:</strong> <span>{createdDate ? moment(createdDate).format("DD/MM/YYYY hh:mm") : ""}</span>
            </p>
            <p className='m-0'>
          ...
          <div className='d-flex align-items-center'>
            <p className='m-0'>
              <strong style={{color: '#5e5873'}}>Ngày sửa:</strong> <span>{updatedDate ? moment(updatedDate).format("DD/MM/YYYY hh:mm") : ""}</span>
            </p>
            <p className='m-0'>
