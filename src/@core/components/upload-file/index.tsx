...
const UploadFileComponent = (props: IFDataUploadFile) => {
  const { allowedExtensions, response, multiple } = props
  ...
  return (
    <React.Fragment>
      <div className='upload_wrapper'>
        {/* Render Uploader */}
        <UploaderComponent multiple={multiple} autoUpload={true} asyncSettings={settings} uploading={addHeaders} allowedExtensions={allowedExtensions} success={onSuccsess} />
      </div>
    </React.Fragment>
  )
}
