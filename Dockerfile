...
ENV REACT_APP_PRODUCT_CODE="CMS"
ENV REACT_APP_DEFAULT_AVATAR="http://dev.vfico.local/cdn/vfico.png"
ENV REACT_APP_BASE_URL="http://dev.vfico.local/cms-gw"
ENV REACT_APP_ENV="production"
ENV REACT_APP_CLIENT_ID="vfico"
ENV REACT_APP_CLIENT_SECRET="cD8N8r2oLqdSWcOX5JDXhvUkLRXADqPF"
ENV REACT_APP_SCOPE="openid profile offline_access"
ENV REACT_APP_AUTHORITY="https://id.vfico.com/realms"
